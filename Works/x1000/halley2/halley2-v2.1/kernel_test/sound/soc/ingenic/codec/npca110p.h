...
static unsigned char g_abMaxxDSPCommands[] =
{
...
#else
        0x00, 0xc3, 0x01, /* Command SAMPLE, Value = 44.1 kHz             */
#endif
        0x00, 0xa4, 0x11, /* Command ANALOG_SETTING                     */
        0x0f, 0xff, 0xff, /* M1  0dB                                    */
        0x00, 0x00, 0x00, /*                                            */
        0x00, 0x00, 0x00, /*                                            */
	0x0f, 0xff, 0xff, /* M4  0dB                                    */
	0x00, 0x00, 0x00, /*                                            */
        0x00, 0x00, 0x00, /*                                            */
        0x00, 0x00, 0x00, /*                                            */
        0x00, 0x00, 0x00, /*                                            */
        0x7f, 0xff, 0xff, /* M9 0dB                                     */
        0x00, 0x00, 0x00, /*                                            */
        0x7f, 0xff, 0xff, /* M11 0dB                                    */
        0x00, 0x00, 0x00, /*                                            */
        0x00, 0x00, 0x00, /*                                            */
        0x00, 0x00, 0x00, /*                                            */
        0x00, 0x00, 0x00, /*                                            */
        0x00, 0x00, 0x00, /*                                            */
        0x7f, 0xff, 0xff, /* M17 0dB                                    */
        0x00, 0xc8, 0x00, /* Command UPD_ANALOG                         */
        0xbf, 0xc4, 0xd5, /* Command DIG_IO_CONFIG, npca110p is i2s master */
        0xff, 0xab, 0xfb,
        0x24, 0x10, 0x09, /*                                            */
        0xff, 0xab, 0xfa,
        0x08, 0x00, 0x09, /*                                            */
        ...
        0xff, 0xad, 0x84,
#ifdef USE_48000_SAMPLE_RATE
        0x00, 0x00, 0x18,  /* 48000 sample rate                          */
#else
        0x00, 0x00, 0x17, /* 44100 sample rate                          */
#endif
        0xff, 0xad, 0x85,
        0x00, 0x1f, 0xff, /*                                            */
        0xff, 0xad, 0x81,
        ...
        0x00, 0x14, 0x14, /*                                            */
        0xff, 0xad, 0x83,
        0x00, 0x02, 0x88, /* High-pass filter used, LIN1/RIN1, stereo   */
        0xff, 0xad, 0x80,
        0x00, 0x50, 0x50, /*                                            */
        0xff, 0xad, 0x87,
        0x00, 0x50, 0x50, /*                                            */
        ...
        0x00, 0xd5, 0x5b, /* Command MAXX_BASS_FREQUENCY, Value = 69.24Hz */
        ...
        0x00, 0xd9, 0x4a, /* Command MAXX_TREBLE_FREQUENCY, Value = 4305Hz */
...
#if 0
/* Below is replay volume and maxxbass relation table. But here is no use. */
