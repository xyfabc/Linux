...
QT_MOC_LITERAL(3, 22, 14)
    ...
    "ExportData\0updateMsg\0\0progressSwitch"
};
...
void ExportData::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ExportData::*_t)(int , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ExportData::updateMsg)) {
                *result = 0;
            }
        }
        {
            typedef void (ExportData::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ExportData::progressSwitch)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject ExportData::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_ExportData.data,
...
// SIGNAL 0
void ExportData::updateMsg(int _t1, QString _t2)
{
...
// SIGNAL 1
void ExportData::progressSwitch(bool _t1)
{
