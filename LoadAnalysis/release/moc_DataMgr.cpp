...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DataMgr_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 27, 15)
    ...
    "DataMgr\0progressBarSignal\0\0calcCZTpartOver"
};
...
void DataMgr::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->progressBarSignal((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 1: _t->calcCZTpartOver(); break;
        default: ;
        }
        ...
        {
            typedef void (DataMgr::*_t)(int , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DataMgr::progressBarSignal)) {
                *result = 0;
            }
        }
        {
            typedef void (DataMgr::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DataMgr::calcCZTpartOver)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject DataMgr::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DataMgr.data,
      qt_meta_data_DataMgr,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DataMgr.stringdata))
...
// SIGNAL 0
void DataMgr::progressBarSignal(int _t1, QString _t2)
{
